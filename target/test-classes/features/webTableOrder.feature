Feature: Web table user order feature
  ...
  Scenario: User should be able to place order and order seen in web table
    ...
    #Something like this sprint testing we will work on it 3 week,
    #Parameterization is working ONLY for one test data
  ...
  Scenario Template: User should be able to place order and order seen in web table
    ...
    Examples:
      ...
      | MoneyCog    | 2        | Marie Curie        | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/23   | Marie Curie        |
    ...
    #Scenario Outline/Template to use for many(more than one) test data